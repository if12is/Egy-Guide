       ...
       <div class="container-xxl">
           <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
               <a href="{{ url('home') }}" class="app-brand-link gap-2">
                   <span class="app-brand-text demo menu-text fw-bold"><img src="{{ asset('images/EgyGuide.png') }}"
                           alt="EgyGuide" width="120px"></span>
               </a>
                   ...
                   <li class="nav-item navbar-dropdown dropdown-user dropdown">
                       <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                           ...
                           <div class="avatar avatar-online">
                               ...
                               <img src="{{ optional(Auth::user()->getFirstMedia('avatars'))->getUrl() ?: asset('assets/img/avatars/unknown-avatar.jpeg') }}"
                       ...
                       <ul class="dropdown-menu dropdown-menu-end">
                               ...
                               <a class="dropdown-item" href="{{ route('home.profile') }}">
                                   <div class="d-flex">
                                       ...
                                       <div class="flex-grow-1">
                                           ...
                                           echo Auth::user()->is_admin == 1 ? 'Admin' : 'User';
                                           ?> </small>
                                       </div>
                                   </div>
                               </a>
                           ...
                           <li>
                               <a class="dropdown-item" href="{{ route('home.account-edit', Auth::user()->id) }}">
