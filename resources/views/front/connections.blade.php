                            ...
                            <div
                                ...
                                <div class="user-profile-info">
                                    ...
                                    <ul
                                        ...
                                        <li class="list-inline-item d-inline-flex"><i class="ti ti-color-swatch"></i> UX
                                            Designer</li>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="mx-auto my-3">
                            <img src="../../assets/img/avatars/12.png" alt="Avatar Image"
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="mx-auto my-3">
                            <img src="../../assets/img/avatars/5.png" alt="Avatar Image"
                                class="rounded-circle w-px-100" />
                        </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="mx-auto my-3">
                            <img src="../../assets/img/avatars/8.png" alt="Avatar Image"
                                class="rounded-circle w-px-100" />
                        </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="mx-auto my-3">
                            <img src="../../assets/img/avatars/9.png" alt="Avatar Image"
                                class="rounded-circle w-px-100" />
                        </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="mx-auto my-3">
                            <img src="../../assets/img/avatars/10.png" alt="Avatar Image"
                                class="rounded-circle w-px-100" />
                        </div>
