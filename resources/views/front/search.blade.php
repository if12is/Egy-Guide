...
@section('front')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Posts /</span> {{ $query }}</h4>
    @if (count($posts) > 0)
                            ...
                            <div class="social-icons">
                                <section class="icons-section">
                                    ...
                                    <div class="filter mx-3">
                                        <span
                                            class="badge rounded-pill bg-label-primary">#{{ $post->category->name }}</span>
                                ...
                                <div class="likes-wrap likes like-count-num" id="like-count-num"
                                    data-post-id="{{ $post->id }}"><span>{{ $post->reactions()->count() }} </span>
                                    likes
                                </div>
                            </div>
