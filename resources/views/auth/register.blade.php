                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="name"
                                    class="form-control form-control-muted @error('name') is-invalid @enderror"
                            ...
                            <div class="mb-2">
                                ...
                                <input type="email" name="email"
                                    class="form-control form-control-muted @error('email') is-invalid @enderror"
                            ...
                            <div class="mb-2">
                                ...
                                <input type="password" class="form-control form-control-muted" name="password_confirmation"
                                    id="password-confirm" autocomplete="current-password" autofocus>
                            </div>
                                ...
                                <a href="#" class="btn btn-neutral w-full">
                                    <span class="icon icon-sm pe-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <defs>
                                                <linearGradient id="paint0_linear" x1="1.07434" y1="7.03731"
                                                    x2="22.8646" y2="17.1983" gradientUnits="userSpaceOnUse">
                                    ...
                                    <span class="icon icon-sm pe-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path opacity="0.1"
                                                ...
                                                fill="black" />
                                            <path opacity="0.1" d="M12 14.25V14.5H18.4862L18.5875 14.25H12Z"
                                                fill="black" />
                                            <path
                                            ...
                                            <path opacity="0.2"
                                                ...
                                                fill="white" />
                                            <defs>
                                                <linearGradient id="paint0_linear" x1="0" y1="12"
                                                    x2="24" y2="12" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="white" stop-opacity="0.2" />
                                                    <stop offset="1" stop-color="white" stop-opacity="0" />
                                                </linearGradient>
                                            </defs>
